...
static const char *TAG = "ESP32-S3-MOBILE";
...
esp_err_t bsp_audio_init(const i2s_pdm_tx_config_t *i2s_config, i2s_chan_handle_t *tx_channel)
{
    ...
    /* Setup I2S channels */
    const i2s_pdm_tx_config_t pdm_cfg_default = BSP_I2S_DUPLEX_MONO_CFG(16000);
...
esp_codec_dev_handle_t bsp_audio_codec_speaker_init(void)
{
    gpio_config_t io_conf = {
        .pin_bit_mask = BIT64(BSP_SPENAK_EN),
...
{
    gpio_set_level(BSP_SPENAK_EN, enable);
    return ESP_OK;
}
